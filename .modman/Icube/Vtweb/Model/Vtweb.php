...
use Icube\Vtweb\Model\Config\Source\Order\Status\Paymentreview;
use Magento\Sales\Model\Order;

class Vtweb extends \Magento\Payment\Model\Method\AbstractMethod
{
    const VTWEB_PAYMENT_CODE = 'vtweb';
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $_formBlockType = 'Icube\Vtweb\Block\Form\Vtweb';
