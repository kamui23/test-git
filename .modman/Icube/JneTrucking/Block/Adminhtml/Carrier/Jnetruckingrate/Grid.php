...
namespace Icube\JneTrucking\Block\Adminhtml\Carrier\Jnetruckingrate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Icube\JneTrucking\Model\ResourceModel\Carrier\Jnetruckingrate\CollectionFactory $collectionFactory,
        \Icube\JneTrucking\Model\Carrier\Jnetruckingrate $tablerate,
        array $data = []
    )
    {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'weight_min',
            ['header' => __('Minimum Weight'), 'index' => 'weight_min']
        );
